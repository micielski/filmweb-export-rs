...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    for (what, pages_count, page_type) in [
        ("films", films_pages, FwPageType::Films),
        ("serials", serials_pages, FwPageType::Serials),
        ("wants2see", wants2see_pages, FwPageType::WantsToSee),
    ] {
...
async fn get_imdb_data_and_save(
